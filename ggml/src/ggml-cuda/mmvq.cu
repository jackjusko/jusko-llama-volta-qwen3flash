...
// Hot MoE-cache matvecs. Separate from mul_mat_vec_q_moe so Volta kernels stay intact.
...
static void mul_mat_vec_q_moe_cache_launch(
    ...
    ggml_cuda_kernel_launch(mul_mat_vec_q_moe_cache<type, rows_per_block, has_fusion, has_clamp>, launch_params,
